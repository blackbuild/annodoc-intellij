...
- Each slice delivers a narrow but complete path through every relevant layer (plugin registration, IntelliJ Platform seam, implementation, tests, and documentation where applicable)
